module FlickrApiStubHelper
  ...
  SEARCH_RESPONCE = { 'photos':
    { 'page': 1,
      'pages': '59298',
      'perpage': 10,
      'total': '592980',
      'photo': [
        { 'id': '24932258435', 'owner': '96711656@N07', 'secret': '435b9810c8', 'server': '1458', 'farm': 2,
          'title': 'CBS201602100830.jpg', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24905333176', 'owner': '81996688@N07', 'secret': '03eb9f6905', 'server': '1490', 'farm': 2,
          'title': 'Formula One Testing', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24564007179', 'owner': '81996688@N07', 'secret': '76504d5923', 'server': '1500', 'farm': 2,
          'title': 'Formula One Testing', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24813674542', 'owner': '81996688@N07', 'secret': '89291c8fc1', 'server': '1592', 'farm': 2,
          'title': 'Formula One Testing', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24813551652', 'owner': '96711656@N07', 'secret': '142519128e', 'server': '1538', 'farm': 2,
          'title': 'CBS201602100730.jpg', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24838108311', 'owner': '19907396@N00', 'secret': '099272bbb5', 'server': '1493', 'farm': 2,
          'title': 'Mireia', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24300750114', 'owner': '131891481@N05', 'secret': '7e884b9986', 'server': '1619', 'farm': 2,
          'title': 'DSC_0093', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24304500903', 'owner': '131891481@N05', 'secret': '11b9ef705d', 'server': '1638', 'farm': 2,
          'title': 'DSC_0193', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24838013681', 'owner': '131891481@N05', 'secret': 'efa5682a8a', 'server': '1640', 'farm': 2,
          'title': 'DSC_0182', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 },
        { 'id': '24813391572', 'owner': '131891481@N05', 'secret': '288f2d6441', 'server': '1533', 'farm': 2,
          'title': 'DSC_0147', 'ispublic': 1, 'isfriend': 0, 'isfamily': 0 }
      ] }, 'stat': 'ok' }
